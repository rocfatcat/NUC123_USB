...
/** @addtogroup NUC123_ADC_Driver ADC Driver
  @{
*/

/** @addtogroup NUC123_ADC_EXPORTED_CONSTANTS ADC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC123_ADC_EXPORTED_CONSTANTS */

/** @addtogroup NUC123_ADC_EXPORTED_FUNCTIONS ADC Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC123_ADC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC123_ADC_Driver */
