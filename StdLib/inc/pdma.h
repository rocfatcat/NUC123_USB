...
/** @addtogroup NUC123_PDMA_Driver PDMA Driver
  * @{
  */

/** @addtogroup NUC123_PDMA_EXPORTED_CONSTANTS PDMA Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC123_PDMA_EXPORTED_CONSTANTS */

/** @addtogroup NUC123_PDMA_EXPORTED_FUNCTIONS PDMA Exported Functions
  @{
*/
