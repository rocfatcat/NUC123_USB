...
/** @addtogroup NUC123_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC123_GPIO_EXPORTED_CONSTANTS */
 ...
 *                          It could be BIT0 ~ BIT5 and BIT8 ~ BIT13 for PC GPIO port.
 *                          It could be BIT0 ~ BIT5 and BIT8 ~ BIT11 for PD GPIO port.
 *                          It could be BIT0 ~ BIT3 for PF GPIO port. *                          It could be BIT0 ~ BIT15 for PA, PB, PC, PD and PE GPIO port.
 *                          It could be BIT0 ~ BIT3 for PF GPIO port.
 *
 * @return      None
 *
