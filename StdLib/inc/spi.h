...
/** @addtogroup NUC123_SPI_Driver SPI Driver
  @{
*/

/** @addtogroup NUC123_SPI_EXPORTED_CONSTANTS SPI Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC123_SPI_EXPORTED_CONSTANTS */


/** @addtogroup NUC123_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
...
/**
  ...
  * @param[in]  spi The pointer of the specified SPI module.
  * @return     None.
  * @details    Disable automatic slave selection function and set SPIn_SS1 pin to high state.
  */
...
/**
  ...
  * @param[in]  spi The pointer of the specified SPI module.
  * @return     None.
  * @details    Disable automatic slave selection function and set SPIn_SS1 pin to low state.
  */
#define SPI_SET_SS1_LOW(spi)   ((spi)->SSR = ((spi)->SSR & (~(SPI_SSR_AUTOSS_Msk|SPI_SSR_SS_LVL_Msk))) | SPI_SS1)
