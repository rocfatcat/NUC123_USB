 ...
 * $Revision: 1 $
 * $Date: 14/06/18 5:34p $
 * @brief    NUC123 series WWDT driver header file
 *
 * @note
...
/** @addtogroup NUC123_WWDT_Driver WWDT Driver
  @{
*/

/** @addtogroup NUC123_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC123_WWDT_EXPORTED_CONSTANTS */


/** @addtogroup NUC123_WWDT_EXPORTED_FUNCTIONS WWDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC123_WWDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC123_WWDT_Driver */
