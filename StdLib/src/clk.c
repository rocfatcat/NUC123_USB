...
/** @addtogroup NUC123_CLK_Driver CLK Driver
  @{
*/

/** @addtogroup NUC123_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    else
    {
        ...
        u32CLK_SRC = CLK_PLLCON_PLL_SRC_Msk;
        u32PllSrcClk = __HIRC;
        u32NR = 4; /* u32NR start from 4 when FIN = 22.1184MHz to avoid calculation overflow */
    }
...
/*@}*/ /* end of group NUC123_CLK_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC123_CLK_Driver */
